...
class QualitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quality" do
    assert_difference('Quality.count') do
      post qualities_url, params: { quality: { description: @quality.description, kind: @quality.kind, name: @quality.name, user_id: @quality.user_id } }
    end
  ...
  test "should update quality" do
    patch quality_url(@quality), params: { quality: { description: @quality.description, kind: @quality.kind, name: @quality.name, user_id: @quality.user_id } }
